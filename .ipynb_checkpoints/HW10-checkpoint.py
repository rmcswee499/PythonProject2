...
# These compare the values for each model technique 
# to the true values for either the training or testing dataset these predictions were based off of. 

# Step 5: Summary
# Which method performs the best? Why?
# The support vector machine (SVM) model appears to perform the best